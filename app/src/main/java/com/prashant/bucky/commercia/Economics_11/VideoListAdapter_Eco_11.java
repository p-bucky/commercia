...
public class VideoListAdapter_Eco_11 extends BaseAdapter implements YouTubeThumbnailView.OnInitializedListener {

    private Context mContext;
    private Map<View, YouTubeThumbnailLoader> mLoaders;

    public VideoListAdapter_Eco_11(final Context context) {
        mContext = context;
    ...
    @Override
    public int getCount() {
        return YouTubeContent_Eco_11.ITEMS.size();
    }

    @Override
    public Object getItem(int position) {
        return YouTubeContent_Eco_11.ITEMS.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final YouTubeContent_Eco_11.YouTubeVideo item = YouTubeContent_Eco_11.ITEMS.get(position);
