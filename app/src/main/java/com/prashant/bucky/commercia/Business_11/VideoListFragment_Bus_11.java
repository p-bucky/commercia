...
public class VideoListFragment_Bus_11  extends ListFragment {

    /**
     * Empty constructor
     */
    public VideoListFragment_Bus_11() {
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setListAdapter(new VideoListAdapter_Bus_11(getActivity()));
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final YouTubeContent_Bus_11.YouTubeVideo video = YouTubeContent_Bus_11.ITEMS.get(position);
